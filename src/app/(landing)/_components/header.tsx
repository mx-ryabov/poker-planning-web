...
import { NextLinkButton } from "@/src/shared/ui/next-components/next-link";
import gsap from "gsap";
import { ScrollTrigger } from "gsap/ScrollTrigger";
import { useGSAP } from "@gsap/react";
import { Button } from "@/src/shared/ui/components/button";
import { MenuIcon } from "@/src/shared/ui/components/icon/svg/menu.icon";
import { CloseIcon } from "@/src/shared/ui/components/icon/svg/close.icon";
import { Modal, ModalOverlay } from "react-aria-components";
import { AnimatedText } from "@/src/shared/ui/components/animated-text";
import { AnimatedFadeIn } from "@/src/shared/ui/components/animated-fade-in";
...
export function Header({ containerId }: HeaderProps) {
	...
	return (
		...
		>
			...
			>
				<Modal className="h-full w-full relative flex flex-col">
					<div className="flex w-full flex-row justify-between px-6 py-4 md:max-w-2xl lg:max-w-4xl xl:max-w-5xl xl:gap-6">
						<AnimatedFadeIn>
							<Link
								onPress={() => onNavLinkPress("/#hero")}
...
function useMenuOpenCloseAnimation({
	...
	useGSAP(
		...
		{
			dependencies: [isMenuOpen, containerId, menuContainerRef, modalRef],
			revertOnUpdate: true,
		},
	);
