...
export * from "./svg/crown.icon";
export * from "./svg/info.icon";
export * from "./svg/filter.icon";
...
export * from "./svg/ticket-story.icon";
export * from "./svg/ticket-bug.icon";
export * from "./svg/ticket-task.icon";
