...
import { ClockIcon } from "@/src/shared/ui/components/icon/svg/clock.icon";
import { LinkIcon } from "@/src/shared/ui/components/icon/svg/link.icon";
import { MagicPenIcon } from "@/src/shared/ui/components/icon/svg/magic-pen.icon";
